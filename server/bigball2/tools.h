#ifndef TOLLS_H_INCLUDE
//作用是防止多重定义
#define TOLLS_H_INCLUDE
...
map<int, int> socket_room;
map<int, char*> socket_username;
...
bool startWith(char* string, const char* startString) {
    int startStringlen = strlen(startString);
    int stringlen = strlen(string);
    if (stringlen < startStringlen) {
        return false;
    }
    bool res = true;
